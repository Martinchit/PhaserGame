...
class GameStart {
    ...
    create() {
        ...
        sunLimit = 700;
        fireSpeed = 400;
        fireLimit = 150 + Math.random()*1000;
        score = 0;
...
update() {
        ...
        fireGroup.forEach(function(fire) {
     ...
     if (health <=0 || health >= 100) {
                ...
                this.gamewinsign = game.add.bitmapText(game.world.centerX, game.world.centerY, "font", "You win!", 80);
                this.gamewinsign.anchor.setTo(0.5);
           ...
           /* if(sunGroup[sunGroup.length-1].kill === true) {
                score = 40001;
            } */
...
class Sun extends Phaser.Sprite {
    ...
    update() {
        if(this.placeBarrier && this.y > sunLimit || this.kill === true){
            this.placeBarrier = false;
